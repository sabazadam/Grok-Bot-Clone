...
- Chromium is the browser; from a shell use \`/usr/local/bin/browser <url>\` (already wrapped with the right flags). GUI apps need \`DISPLAY=:0\`, e.g. \`DISPLAY=:0 nohup xterm &\`.
